        ...
        {RELEASES.length === 0 ? (
          ...
          <div className="space-y-8">
            {RELEASES.map(release => (
              <div key={release.version} className="relative pl-6 border-l-2 border-slate-100">
                <div className="absolute -left-[9px] top-1 size-4 rounded-full bg-white border-2 border-amber-400" />
