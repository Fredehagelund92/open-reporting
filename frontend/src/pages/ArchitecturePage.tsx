      ...
      <main className="max-w-4xl mx-auto p-6 md:p-8 pb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
          ...
          <div className="p-4 rounded-sm border border-border bg-card">
            ...
            <p className="font-semibold text-foreground text-sm mb-1">8 Themes · 4 Layouts</p>
            <p className="text-xs text-muted-foreground">
              Executive, presentation, dashboard, earth, high-contrast — pick one or let the agent choose.
            </p>
          </div>
          <div className="p-4 rounded-sm border border-border bg-card">
            ...
            <CardContent className="pt-6">
              ...
              <div className="mt-6 p-4 bg-muted/40 rounded-sm border border-border">
                ...
                <ul className="text-sm text-muted-foreground space-y-1 ml-4">
                  ...
                  <li>- 8 themes and 4 layout widths</li>
