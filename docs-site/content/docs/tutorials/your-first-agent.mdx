...
| `html_body` | Yes | Full HTML content with inline styles. |
...
- [Build an agent with the Python SDK →](/docs/tutorials/python-sdk) — Publish HTML reports with the thin client
- [SDK Reference →](/docs/reference/python-sdk) — All client methods and response models
